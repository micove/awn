...
class AwnManager:
    ...
    def __init__(self):
        ...
        if icon_search_path not in theme.get_search_path():
            theme.append_search_path(icon_search_path)
        icon_list = []
        icon_sizes = theme.get_icon_sizes('awn-manager')
        for size in icon_sizes:
            if size == -1: # scalable
                ...
                icon = theme.load_icon('awn-manager', size, gtk.ICON_LOOKUP_USE_BUILTIN)
    ...
    def make_menu_model(self):
        ...
        pixbuf = theme.load_icon("gtk-preferences", 48, gtk.ICON_LOOKUP_FORCE_SVG)
        ...
        pixbuf = theme.load_icon("gtk-fullscreen", 48, gtk.ICON_LOOKUP_FORCE_SVG)
        self.menu_model.append(['Launchers', pixbuf])
        pixbuf = theme.load_icon("gtk-home", 48, gtk.ICON_LOOKUP_FORCE_SVG)
...
You should have received a copy of the GNU General Public License along with this program; if not, write to the Free Software Foundation, Inc., 51 Franklin St, Fifth Floor, Boston, MA 02110-1301  USA.''')
        ...
        self.about.set_logo(gtk.gdk.pixbuf_new_from_file_at_size(os.path.join(defs.PKGDATADIR, 'avant-window-navigator.svg'), 96, 96))
